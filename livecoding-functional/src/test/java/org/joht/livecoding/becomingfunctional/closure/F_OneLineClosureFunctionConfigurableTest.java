...
public class F_OneLineClosureFunctionConfigurableTest {
	...
	public F_OneLineClosureFunctionConfigurableTest(RightTrimTestCase testCase) {
		this.testCase = testCase;
	}

	@Test
	public void testCaseShouldBeFulfilled() {
		UnaryOperator<String> functionUnderTest = F_OneLineClosureFunctionConfigurable.standardRightTrim();	
